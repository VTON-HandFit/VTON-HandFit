...
class OOTDiffusionDC_ori:
    ...
    def __init__(self, gpu_id, model_root):
        ...
        unet_garm = UNetGarm2DConditionModel.from_pretrained(
            "/apdcephfs_cq8/share_2992679/private/byronjiang/try-on/code/wear-any-way/run/trained_checkpoints/ootd_trained_hd_768_hd_dcupper_newagn_garm_unscaled_dwpose_from_384_pretrain/checkpoint-58000/unet_garm",
            torch_dtype=torch.float16,
        )
        unet_vton = UNetVton2DConditionModel.from_pretrained(
            "/apdcephfs_cq8/share_2992679/private/byronjiang/try-on/code/wear-any-way/run/trained_checkpoints/ootd_trained_hd_768_hd_dcupper_newagn_garm_unscaled_dwpose_from_384_pretrain/checkpoint-58000/unet_vton",
            torch_dtype=torch.float16,
        )
        pose_guider = PoseGuider(conditioning_embedding_channels=320, conditioning_channels=3, block_out_channels=(16, 32, 96, 256))
        pose_guider.load_state_dict(torch.load("/apdcephfs_cq8/share_2992679/private/byronjiang/try-on/code/wear-any-way/run/trained_checkpoints/ootd_trained_hd_768_hd_dcupper_newagn_garm_unscaled_dwpose_from_384_pretrain/checkpoint-58000/pose_guider/diffusion_pytorch_model.bin"))
